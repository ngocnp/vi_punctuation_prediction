...
optimizer = AdamW(optimizer_grouped_parameters, lr=learning_rate0, warmup=warmup_proportion, t_total=total_train_steps)
...
for epoch in range(start_epoch, total_train_epochs):
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        if (step + 1) % gradient_accumulation_steps == 0:
            ...
            lr_this_step = learning_rate0 * get_linear_schedule_with_warmup(global_step_th/total_train_steps, warmup_proportion)
